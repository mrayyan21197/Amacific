...
const HeaderBottom = () => {
  ...
  useEffect(() => {
    // click-outside handler for the category menu
    const handleClickOutside = (e) => {
      // guard against null and check if click is inside the menu trigger
                ...
                {filteredProducts.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <p className="text-sm">
                        Price: <span className="text-primeColor font-semibold">
                          ${item.price}
                        </span>
                      </p>
                    </div>
